                                    ...
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            {/* <ul className="text-sm text-gray-500">
                                                <li>
                                                    Click "next question" to
                                                    randomly generate a question
                                                    from the source book.
                                                </li>
                                                <li>
                                                    Once you think you have the
                                                    answer, click "solution" to
                                                    reveal the answer
                                                </li>
                                                <li>
                                                    Sometimes, the book provides
                                                    hint. If your question comes
                                                    with hints, you will be able
                                                    to see it by clicking on the
                                                    "show hint" button.
                                                </li>
                                                <li>
                                                    Everytime you click "next
                                                    question", a timer will
                                                    start. You can click
                                                    show/hide timer to show/hide
                                                    the timer.
                                                </li>
                                            </ul> */}
                                        </div>
